...
> **The first language with built-in MCP — server and client. 241 builtins, single ~8 MB binary. Zero dependencies.**
...
- **241 builtins** — 36 AI + 13 MCP + 190 standard, up from 226 in v0.9.3
...
Source (.pipe) -> Lexer -> Parser -> AST -> [ Tree-Walker | Compiler + VM ]
                                              |
                                    Builtins (241 total: 36 AI + 13 MCP + 190 standard)
                                              |
