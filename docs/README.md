...
Pipe combines **Python-like readability** (indentation-based, no braces) with **Unix shell pipelines** and the **portability of a single Go binary** (~16 MB, zero external dependencies).
...
- **Builtins**: 143 (32 AI + 111 Standard)
- **Opcodes**: 40
- **AST node types**: 34
- **Example programs**: 52
