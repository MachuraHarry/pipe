...
```pipe
d.d_webhook_embed WEBHOOK_URL {title: "Build #42", description: "Alle Tests bestanden", color: 65280}
```
...
```pipe
d.d_send_embed TOKEN CHANNEL_ID {title: "Server-Status", description: "Alle Systeme betriebsbereit", color: 255}
```
