...
| 🤖 **Use AI features** | → [AI Builtins](19-ai-builtins.md) — 41 AI operations as language primitives |
...
10. [Builtin Reference](10-builtin-reference.md) — All 238 built-in functions
...
13. [Bytecode VM](13-bytecode-vm.md) — 43 opcodes, stack machine, symbol table
