...
func TestChatSwarmHandoffSwitchesAgent(t *testing.T) {
	...
	result, err := ChatSwarm("triage", agents, "What do I owe?", nil, 5)
	if err != nil {
...
func TestChatSwarmToolCallUsesExecutor(t *testing.T) {
	...
	result, err := ChatSwarm("billing", agents, "What's on my invoice?", executor, 5)
	if err != nil {
		t.Fatalf("ChatSwarm: unexpected error: %v", err)
	}
...
func TestChatSwarmRejectsDisallowedHandoffTarget(t *testing.T) {
	...
	result, err := ChatSwarm("triage", agents, "Reboot my router", nil, 5)
	if err != nil {
		t.Fatalf("ChatSwarm: unexpected error: %v", err)
	}
...
func TestChatSwarmMaxRoundsExceeded(t *testing.T) {
	...
	_, err := ChatSwarm("triage", agents, "loop forever", nil, 2)
...
func TestChatSwarmUnknownEntryAgent(t *testing.T) {
	_, err := ChatSwarm("nope", map[string]SwarmAgentSpec{}, "hi", nil, 5)
	if err == nil {
