...
func (c *Compiler) Compile(node ast.Node) error {
	...
	case *ast.FnStatement:
		...
		if err := c.compileFnLiteralBody(n.Parameters, n.Body, n.Name.Value); err != nil {
			return err
		}
...
// compileVarStatement).
//
// selfName, when non-empty, makes the function's own name resolve to
...
// function recurses.
func (c *Compiler) compileFnLiteralBody(params []*ast.Identifier, body *ast.BlockStatement, selfName string) error {
	c.enterScope()
	if selfName != "" {
		c.symbolTable.DefineFunctionName(selfName)
	}
