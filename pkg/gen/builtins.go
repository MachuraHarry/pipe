...
var builtinInfos = map[string]builtinInfo{
	...
	"map":            {2, strs(TypeAny, TypeAny)},
	"filter":         {2, strs(TypeAny, TypeAny)},
	"reduce":         {3, strs(TypeAny, TypeAny, TypeAny)},
	"each":           {2, strs(TypeAny, TypeAny)},
	"abs":            {1, strs(TypeInt)},
	...
	"classify":       {2, strs(TypeString, TypeAny)},
	"extract":        {2, strs(TypeAny, TypeAny)},
	...
	"ai_chat":        {2, strs(TypeAny, TypeAny)},
	"embed":          {1, strs(TypeAny)},
